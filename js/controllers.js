...
function MainCtrl($scope, $http,$location) {
    ...
    var url = "http://localhost/Payroll-tracking-system/json/rex.json";
    if($location.path().val = "/dashboards/govtrackerSearch"){
        //StreamData();
    }

   let  dummyfile = {
        Filename: "Payroll 2016",
        FileUrl: "http://docs.google.com/myfile.xls",
        FileLocation: "Budget Department",
        CurrentEditor: "Rex Adrivan",
        ApprovedBy: [{
            Name: "Rex Adrivan",
            PhotoUrl: "https://scontent.fmnl4-3.fna.fbcdn.net/v/t1.0-9/16174408_745849778905792_5084792650409529509_n.jpg?oh=77d100057f12b8d30895712741ed02f0&oe=59D88CC3",
            Department: "CMO"
        },{
            Name: "Loy Adrivan",
            PhotoUrl: "https://scontent.fmnl4-3.fna.fbcdn.net/v/t1.0-9/312234_278914268788078_886014991_n.jpg?oh=24484a63394483bbcfbdd48501e67d1d&oe=59A337C9",
            Department: "IT"
        }]
    };
